  ...
  return (
    <div className="grid grid-cols-3 items-center mt-8 px-4 bg-background">
      ...
      <nav className="flex justify-center space-x-2 sm:space-x-4 md:space-x-6">
        <Link href="/" className="text-casualTextGray hover:text-gray-400 text-md">
          Home
        </Link>
        <Link href="/about" className="text-casualTextGray hover:text-gray-400">
          About
        </Link>
        <Link
          href="/contact"
          className="text-casualTextGray hover:text-gray-400"
        >
          Contact
        </Link>
      </nav>
